...
<head>
    ...
    <style>
        ...
        *{box-sizing:border-box}
        ...
        .stat-card:hover{transform:translateY(-6px);box-shadow:0 12px 30px rgba(0,0,0,0.08);transition:all .18s}
        .table-card{background:#fff;border-radius:12px;padding:0;box-shadow:0 6px 20px rgba(0,0,0,0.05)}
        /* Sidebar nav hover */
        .sidebar .nav-link:hover{background:rgba(30,58,95,0.04);border-radius:8px;padding-left:12px}
        .sidebar .nav-link.fw-bold{background:rgba(30,58,95,0.06);border-radius:8px;padding-left:12px}
